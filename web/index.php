      ...
      switch ( $data->type )
      {
        ...
        case 'message_new':
             ...
             $problem = array(
              ...
              if ($slovo == 'привет' or $slovo == 'Привет')  {
             ...
             if ($slovo == 'курит закрыт' or $slovo == 'закрыт курит' or $slovo == 'Курит закрыт' or $slovo == 'Закрыт курит')  {
             ...
             if ($slovo == $problem['sleng'] or $slovo == 'сленг')  {
             ...
             if ($slovo == 'сбегает закрыт' or $slovo == 'закрыт сбегает' or $slovo == 'Сбегает закрыт' or $slovo == 'Закрыт сбегает')  {
             ...
             if ($slovo == 'курит сбегает' or $slovo == 'сбегает курит' or $slovo == 'Курит сбегает' or $slovo == 'Сбегает курит')  {
                 $request_params['message'] = 'Данные события могли выйти из тяжелых душевных волнений' ;
              }

             if ($slovo == $problem['sekond'] or $slovo == 'сбегает') {
             ...
             if ($slovo == $problem['first'] or $slovo == 'курит') {
